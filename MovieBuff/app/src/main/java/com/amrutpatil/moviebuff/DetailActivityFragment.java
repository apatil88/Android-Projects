...
public class DetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTrailerAdapter = new MovieTrailerAdapter(getActivity(), new ArrayList<MovieTrailer>());
        ...
        mTrailersView.setOnItemClickListener(new LinearListView.OnItemClickListener() {
            ...
            public void onItemClick(LinearListView linearListView, View view,
                ...
                MovieTrailer trailer = mTrailerAdapter.getItem(position);
        ...
        mReviewAdapter = new MovieReviewAdapter(getActivity(), new ArrayList<MovieReview>());
        ...
        if (mMovie != null) {
            ...
            mOverviewView.setText(mMovie.getMoviePlotSynopsis());

            String movie_date = mMovie.getMovieReleaseDate();
            ...
            mVoteAverageView.setText(Integer.toString(mMovie.getMovieUserRating()));
        }
...
*/
    ...
    public void onStart() {
        super.onStart();
        if (mMovie != null) {
            new FetchTrailersTask().execute(Integer.toString(mMovie.getMovieId()));
            new FetchReviewsTask().execute(Integer.toString(mMovie.getMovieId()));
        }
    }
    ...
    private Intent createShareMovieIntent() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, mMovie.getMovieTitle() + " " +
    ...
    public class FetchTrailersTask extends AsyncTask<String, Void, List<MovieTrailer>> {
        ...
        private List<MovieTrailer> getTrailersDataFromJson(String jsonStr) throws JSONException {
            ...
            for (int i = 0; i < trailerArray.length(); i++) {
                ...
                if (trailer.getString("site").contentEquals("YouTube")) {
                    MovieTrailer trailerModel = new MovieTrailer(trailer);
