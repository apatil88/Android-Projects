...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteHolder> {
    ...
    // to represent an item.  Inflate the XML layout and return our view (NoteHolder)
    @Override
    ...
    // after the non image data has been changed.  Hence,
